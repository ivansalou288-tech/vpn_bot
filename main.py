    ...
    if status == "has_subscription":
        ...
        if is_enabled:
            subscription_keyboard = InlineKeyboardMarkup(
                inline_keyboard=[
                    [InlineKeyboardButton(text="Использовать", url=f"https://www.ezhqpy.ru/rUGq18rXII/{sub_id}", callback_data=f"use_sub_{sub_id}", style="primary", icon_custom_emoji_id='5271604874419647061')],
